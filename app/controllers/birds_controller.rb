class BirdsController < ApplicationController
  ...
  private
    ...
    def bird_params
      params.require(:bird).permit(:common_english_name, :scientific_name, :family, :order, :marathi_name, :sanskrit_name, :sanskrit_name_description, :scientific_name_etymology, :iucn_status)
    end
end
